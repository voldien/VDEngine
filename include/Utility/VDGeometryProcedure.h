...
public:
	 ...
	 *	@Return
	 */
	static VDMesh* VDAPIENTRY createQuad(float width, float height,
			unsigned int subDivision, bool PivotPoint = true);
	 ...
	 *	@Return
	 */
	static VDMesh* VDAPIENTRY createSphere(float radius, unsigned int Slices,
	 ...
	 *	@Return
	 */
	static VDMesh* VDAPIENTRY createGrid(unsigned int x, unsigned int y,
			float deltaSpace, GridType gridFlag);
