...
class VDDECLSPEC VDTriangle : public VDShape {
  public:
	...
	/**/
	inline void setPos0(const VDVector3 &pos) { p0 = pos; }

	/**/
	inline void setPos1(const VDVector3 &pos) { p1 = pos; }

	/**/
	inline void setPos2(const VDVector3 &pos) { p2 = pos; }
...
inline VDVector3 VDTriangle::getEdge0() const { return (p0 - p1); }

inline VDVector3 VDTriangle::getEdge1() const { return (p0 - p2); }

inline VDVector3 VDTriangle::getEdge3() const { return (p2 - p1); }

inline VDVector3 VDTriangle::getNormal() const { return cross(p0 - p1, p0 - p2) / dot(p0 - p1, p0 - p2); }
