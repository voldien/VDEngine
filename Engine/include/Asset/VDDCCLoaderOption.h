...
class VDAssetConstant {
  public:
	enum AssertLoad : unsigned long int {
		...
		eImportDefault = (eTextureCompressed | eMeshReference | eRigidBodyBySceneData | eCollision | eSkinned |
						  eAnimation | eMaterial | eLight | eTexture | eMesh | VDMesh::eVertex | VDMesh::eNormal |
						  VDMesh::eTangent | VDMesh::eTextureCoord | eDefaultReflection | eHierarchy),
...
#define IMPORT_MESH                                                                                                    \
	(unsigned long long)(VDAssetConstant::eMesh | VDMesh::eVertex | VDMesh::eNormal | VDMesh::eTangent |               \
...
#define IMPORT_SHADERTESSELLATION                                                                                      \
	(unsigned long long)VDAssetConstant::eShaderTessellation // material with displacement texture will get tessleation
