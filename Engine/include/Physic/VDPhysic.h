...
class VDDECLSPEC VDPhysic : fragcore::Singleton<VDPhysic> {
  public:
	 ...
	 */
	static void VDAPIENTRY initialize();

	/**
	 *	release alldData association with physic.
	 */
	static void VDAPIENTRY release();
	 ...
	 */
	static int VDAPIENTRY initVehicleSDK();

	/**
	 *
	 */
	static int VDAPIENTRY initialzeScene();

  public:
	/**
	 *	simulate the physic objects.
	 */
	static void VDAPIENTRY simulation();

	/**
	 *
	 */
	static void VDAPIENTRY update();

	static void VDAPIENTRY setGravity(const VDVector3 &gravity);

	static VDVector3 VDAPIENTRY getGravity();

	/**
	 *
	 *	@Return
	 */
	static bool VDAPIFASTENTRY isPhysicEnabled();
  ...
  public: /*	*/
	 ...
	 *	Clone Actor
	 */
	static physx::PxRigidActor *VDAPIENTRY copyInstanceActor(VDPhysicActor *origonalActor, VDPhysicActor *CloneActor,
	 ...
	 *	@Return
	 */
	static physx::PxPhysics *VDAPIFASTENTRY getPhysicHandle();

	/**
	 *
	 *	@Return
	 */
	static physx::PxScene *VDAPIFASTENTRY getPhysicScene();

	/**
	 *
	 *	@Return
	 */
	static physx::PxFoundation *VDAPIFASTENTRY getFoundationHandle();

	/**
	 *
	 *	@Return
	 */
	static physx::PxControllerManager *VDAPIFASTENTRY getControllerManager();

	/**
	 *
	 *	@Return
	 */
	static physx::PxProfileZoneManager *VDAPIFASTENTRY getProfileZoneManager();

	/**
	 *
	 *	@Return
	 */
	static physx::PxVisualDebugger *VDAPIFASTENTRY getVisualDebugger();

	/**
	 *	Get PhysX Cuda Context Manager Pointer.
	 *	@Return
	 */
	static physx::PxCudaContextManager *VDAPIFASTENTRY getCudaContextManager();
	 ...
	 */
	static physx::PxTransform VDAPIENTRY
	createPxTransformInstance(const VDAABB &offset, const VDQuaternion &quaternion = VDQuaternion::identity());
