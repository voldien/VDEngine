...
class VDDECLSPEC VDAnimationClip : public VDAssetObject {
  ...
  public:
	 ...
	 *	@Return
	 */
	inline const VDCurveList *getCurves() const { return &this->curves; }

	/**
	 *	@Return
	 */
	inline AnimationClipState getState() const { return this->animationState; }

	/**
	 *	@Return
	 */
	inline VDCurve &getCurve(int index) { return this->curves[index]; }

	/**
	 *	@Return
	 */
	inline unsigned int getNumCurves() const { return this->curves.size(); }
	 ...
	 *	@Return
	 */
	inline bool isLoop() const { return (this->getState() & eLoop) != 0; }

	/**
	 *	@Return
	 */
	inline bool isPingPong() const { return (this->getState() & ePingPong) != 0; }
