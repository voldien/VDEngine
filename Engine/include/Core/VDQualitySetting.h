...
public:	/*	Public static methods.	*/
	 ...
	 *	@Return
	 */
	static ShadowFilter VDAPIENTRY getShadowFilter(void);
	 ...
	 *	Get shadow distance.
	 */
	static float VDAPIFASTENTRY getShadowDistance(void);
	 ...
	 */
	static SampleType VDAPIENTRY getSampleMode(void);
	 ...
	 */
	static unsigned int VDAPIENTRY getAntaiAlisingSampling(void);
	 ...
	 */
	static Culling VDAPIENTRY getCulling(void);
	 ...
	 */
	static int VDAPIENTRY getTextureLod(void);
	 ...
	 */
	static float VDAPIENTRY getTextureAnisotropy(void);
	 ...
	 */
	static ColorSpace VDAPIENTRY getColorSpace(void);
	 ...
	 */
	static bool VDAPIENTRY getVSync(void);

	/**
	 * Is shadow enabled.
	 */
	static bool isShadowEnable(void);

	/**
	 *	Is anti-aliasing enabled.
	 */
	static bool isAntiAliasingEnable(void);
