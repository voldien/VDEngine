...
inline unsigned int VDColor32::getColor() const { return this->u; }

inline VDColor32 operator+(const VDColor32 &v1, const VDColor32 &v2) {
	return VDColor32(v1.m[0] + v2.m[0], v1.m[1] + v2.m[1], v1.m[2] + v2.m[2], v1.m[3] + v2.m[3]);
}
inline VDColor32 operator-(const VDColor32 &v1, const VDColor32 &v2) {
	return VDColor32(v1.m[0] - v2.m[0], v1.m[1] - v2.m[1], v1.m[2] - v2.m[2], v1.m[3] - v2.m[3]);
}
inline VDColor32 operator/(const VDColor32 &vec, float scalar) {
	return VDColor32(vec.m[0] / scalar, vec.m[1] / scalar, vec.m[2] / scalar, vec.m[3] / scalar);
}
inline VDColor32 operator*(const VDColor32 &vec, float scalar) {
	return VDColor32(vec.m[0] * scalar, vec.m[1] * scalar, vec.m[2] * scalar, vec.m[3] * scalar);
}
...
inline bool VDColor32::isBlack() const { return (this->r() == 0 && this->g() == 0 && this->b() == 0); }
inline bool VDColor32::isTransparent() const { return (this->a() <= 254); }
