...
class VDDECLSPEC VDLight : public VDFrustum {
  ...
  public: /*	Public method.	*/
	 ...
	 *	@Return
	 */
	inline unsigned int getType() const { return this->type; }
	 ...
	 *	@Return
	 */
	inline VDColor VDAPIENTRY getColor() const { return this->diffuseColor; }
	 ...
	 *	@Return
	 */
	inline float VDAPIENTRY getOuterCone() const { return this->outerCone; }
	 ...
	 *	@Return
	 */
	inline float VDAPIENTRY getInnerCone() const { return this->innerCone; }
	 ...
	 *	@Return
	 */
	inline float VDAPIENTRY getRange() const { return this->range; }
	 ...
	 *	@Return
	 */
	inline float VDAPIFASTENTRY getShadowStrenght() const { return this->shadowStrength; }
	 ...
	 *	@Return
	 */
	inline float VDAPIFASTENTRY getShadowBias() const { return this->shadowBias; }
	 ...
	 *	@Return
	 */
	inline VDRenderTexture *getShadowTexture() const { return this->shadowBuffer; }
	 ...
	 *	@Return
	 */
	inline bool VDAPIFASTENTRY isShadowBufferAttached() const { return (this->getShadowTexture() != nullptr); }
