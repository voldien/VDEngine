...
public:
	 ...
	 */
	bool VDAPIFASTENTRY isValid(void) const;
	 ...
	 */
	bool VDAPIFASTENTRY isCompressed(void) const;

	/**
	 *	Copy current framebuffer to texture.
	 */
	void VDAPIENTRY copy(void);
	 ...
	 *	Get
	 */
	TextureFormat VDAPIENTRY getInternalFormat(void) const;
	 ...
	 *
	 */
	void VDAPIENTRY bind(void)const;
	 ...
	 */
	void VDAPIENTRY unBind(void)const;
	 ...
	 *	@Return
	 */
	WrapMode VDAPIENTRY getWrapMode(void)const;
	 ...
	 *	@Return
	 */
	FilterMode VDAPIENTRY getFilterMode(void)const;
	 ...
	 *	@Return
	 */
	int VDAPIENTRY getBaseLevel(void)const;
	 ...
	 */
	/*TODO perhaps rename */
	int VDAPIENTRY getMaxMipMaps(void);


	/**
	 *	Update mipmapping.
	 */
	void VDAPIENTRY updateMipMap(void);
	 ...
	 *	@Return
	 */
	float VDAPIENTRY getMipMapBias(void)const;


	/**
	 *	Create Alpha Channel of current Textures Luminance.
	 */
	void VDAPIENTRY useRGBAlpha(void);
	 ...
	 *	@Return
	 */
	float VDAPIENTRY getAnsioLevel(void)const;
	 ...
	 */
	TextureDataType VDAPIENTRY getType(void);
...
public:
	 ...
	 *
	 */
	unsigned int VDAPIFASTENTRY getTarget(void) const;
	 ...
	 *
	 */
	unsigned int VDAPIFASTENTRY getTexture(void) const;
...
public:
	 ...
	 *	@Return
	 */
	VDTexture* VDAPIENTRY isTexture(void)const{
	 ...
	 *	@Return
	 */
	VDTexture2D* VDAPIENTRY isTexture2D(void)const{
...
public:
	 ...
	 */
	static float getMaxTextureAnisotropy(void);
