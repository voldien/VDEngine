...
public:	/*	Public methods.	*/
	 ...
	 *	@Return
	 */
	int VDAPIENTRY getSamples();

	/*
	 *	Get color render buffer.
	 *	@Return
	 */
	VDRenderBuffer colorBuffer();

	/*
	 *
	 *	@Return
	 */
	VDRenderBuffer depth();

	/*
	 *
	 *	@Return
	 */
	VDRenderBuffer stencil();
	 ...
	 *
	 */
	void VDAPIENTRY read();

	/*
	 *
	 */
	void VDAPIENTRY write();

	/**
	 *	Clear all attachment buffers.
	 */
	void VDAPIENTRY clear();

	/**
	 *	@Return true if rendertexture is a cubemap.
	 */
	bool VDAPIFASTENTRY isCubemap();

	/**
	 *	@Return true if rendertexture is a 3D texture.
	 */
	bool VDAPIFASTENTRY isVolume();
	 ...
	 *	@Return
	 */
	unsigned int VDAPIENTRY getNumOfAttachment();

	/**/
	bool VDAPIENTRY isColorAttached(Attachment attachment = Attachment::ColorAttachment0);
	bool VDAPIENTRY isDepthAttached();
	bool VDAPIENTRY isStencilAttached();
	 ...
	 *	@Return
	 */
	unsigned int VDAPIENTRY getNumOfRenderBuffer();

	/*
	 *	Check framebuffer error.
	 *	@Return
	 */
	static unsigned int VDAPIENTRY checkError();

	// static unsigned int VDAPIENTRY getMaxColorAttachment(){
